  ...
  const ProEngageOversightPanel = () => {
    ...
    return (
      <div className="space-y-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[10px] font-black text-tata-blue uppercase tracking-[0.3em]">Corporate SPOC View — All TCS Data</span>
            </div>
        ...
        {/* AI Risk Flags */}
        {atRiskList.length > 0 && (
          <div className="bg-red-50/50 rounded-[3rem] p-10 border border-red-100 shadow-sm relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
              {atRiskList.map((v) => (
                <div key={v.id} className="bg-white p-8 rounded-[2.5rem] border border-red-100 shadow-sm hover:shadow-xl transition-all group">
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center font-black text-slate-400 group-hover:bg-red-50 group-hover:text-red-500 transition-colors">
                        {v.name.charAt(0)}
                      </div>
                      <div>
                        <h4 className="font-black text-slate-900 tracking-tight">{v.name}</h4>
                        <p className="text-[10px] font-bold text-tata-blue uppercase tracking-widest">{v.project}</p>
                      </div>
                    </div>
                  ...
                  <div className="p-4 bg-slate-50 rounded-2xl mb-6 border border-slate-100">
                    <p className="text-xs text-slate-700 leading-relaxed">
                      <span className="font-black uppercase text-[10px] text-slate-400 block mb-1 tracking-widest">Reason for Alert</span>
      ...
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-6">
          {[
            ...
            <div key={stat.label} className="bg-white p-8 rounded-[2.5rem] border border-slate-100 text-center shadow-sm hover:shadow-lg transition-all group">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4 group-hover:text-tata-blue transition-colors">{stat.label}</p>
                  ...
                  <tr key={v.id} className="group hover:bg-slate-50/50 transition-all">
                    <td className="py-6 px-6">
                      <button 
                        ...
                        className="font-black text-slate-900 hover:text-tata-blue transition-colors cursor-pointer text-base tracking-tight"
                      >
                        {v.name}
                      </button>
                      <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">{v.email}</div>
                    </td>
                    ...
                    <td className="py-6 px-6">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-black text-slate-900">{v.match}%</span>
                      </div>
                    </td>
                    <td className="py-6 px-6 text-[10px] font-bold text-slate-400 uppercase tracking-widest">{v.lastUpdated}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="bg-gradient-to-br from-white to-slate-50 rounded-[3rem] p-12 shadow-sm border border-slate-100 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            {OPEN_PROENGAGE_PROJECTS.map((project) => (
              <div key={project.id} className="p-8 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 group">
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {project.skills.map(skill => (
                    <span key={skill} className="text-[10px] font-black text-slate-400 bg-slate-50 px-3 py-1.5 rounded-xl uppercase tracking-tight">
                      {skill}
                    </span>
                  ))}
                </div>
                <a 
                  ...
                  className="group/link text-xs font-black text-slate-900 flex items-center gap-2 hover:text-tata-blue transition-colors uppercase tracking-widest"
                >
          ...
          <div className="mt-12 p-6 bg-blue-50 rounded-[2rem] border border-blue-100 flex items-center gap-4 relative z-10">
            <div className="w-10 h-10 rounded-xl bg-tata-blue text-white flex items-center justify-center shadow-lg shadow-blue-900/20">
              <Info size={20} />
            </div>
          ...
          <div className="flex gap-2 p-1.5 bg-slate-100 rounded-2xl shadow-inner">
            {[
              ...
              <button 
                ...
                className={`px-8 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all cursor-pointer flex items-center gap-2 ${
          ...
          <div className="space-y-10">
            <div className="p-6 bg-blue-50 rounded-[2rem] border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <button 
                ...
                className="group px-6 py-3 bg-white border border-blue-100 text-tata-blue rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-tata-blue hover:text-white transition-all cursor-pointer"
              >
                  ...
                  <div key={company.rank} className="flex items-center gap-8 group">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-end mb-3">
                        <span className={`font-black tracking-tight ${company.name === "TCS" ? "text-tata-blue text-lg" : "text-slate-700"}`}>
                          {company.name} {company.name === "TCS" && <span className="text-[10px] font-black uppercase tracking-widest ml-2 opacity-60">(You)</span>}
                        </span>
                        <span className="text-sm font-black text-slate-900">{company.matched.toLocaleString()} <span className="text-[10px] text-slate-400 uppercase ml-1">Matched</span></span>
                      </div>
          ...
          <div className="space-y-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
              ...
              <button 
                ...
                className="group px-8 py-4 bg-zinc-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest flex items-center gap-3 hover:bg-tata-blue transition-all shadow-xl shadow-zinc-900/10 cursor-pointer active:scale-95 disabled:opacity-50"
              >
                {isDownloadingAll ? (
                ...
                <tbody className="divide-y divide-slate-50">
                  {VOLUNTEER_CERTIFICATES.map((cert) => (
                    <tr key={cert.id} className="group hover:bg-slate-50/50 transition-all">
                      <td className="py-6 px-6">
                        <div className="font-black text-slate-900 tracking-tight">{cert.name}</div>
                        <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Volunteer ID: #{cert.id + 1000}</div>
                      </td>
                      <td className="py-6 px-6">
                        <div className="text-sm font-bold text-slate-700">{cert.project}</div>
                        <div className="text-[10px] font-black text-tata-blue uppercase tracking-widest mt-1">{cert.ngo}</div>
                      </td>
                      ...
                      <td className="py-6 px-6 text-right">
                        <div className="flex justify-end gap-3">
                          <button 
                            ...
                            className="w-10 h-10 rounded-xl bg-slate-50 text-slate-400 hover:bg-tata-blue hover:text-white transition-all flex items-center justify-center cursor-pointer shadow-sm"
                            title="Preview Certificate"
                          >
                            <Eye size={18} />
                          </button>
                          <button 
                            className="w-10 h-10 rounded-xl bg-slate-50 text-slate-400 hover:bg-zinc-900 hover:text-white transition-all flex items-center justify-center cursor-pointer shadow-sm disabled:opacity-30"
                            title="Download PDF"
        ...
        {reportsTab === "Feedback" && (
          <div className="space-y-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
              ...
              <div className="text-right bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Overall Completion</p>
                <div className="flex items-center gap-4">
              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-slate-50">
                  {feedbackReminders.map((v) => (
                    <tr key={v.id} className="group hover:bg-slate-50/50 transition-all">
                      <td className="py-6 px-6 font-black text-slate-900 tracking-tight">{v.name}</td>
                      <td className="py-6 px-6 text-sm font-bold text-slate-600">{v.project}</td>
                      <td className="py-6 px-6 text-sm font-medium text-slate-500">{v.dueDate}</td>
                      <td className="py-6 px-6">
                        <div className="flex items-center gap-2 text-red-600">
                          <AlertTriangle size={14} />
                          <span className="text-sm font-black">{v.daysOverdue} days</span>
                        </div>
                      </td>
                      <td className="py-6 px-6">
                        <div className="flex flex-wrap gap-2">
                          {v.reminders.map((r, i) => (
                            <span key={i} className="text-[10px] font-black bg-slate-100 text-slate-500 px-3 py-1.5 rounded-xl uppercase tracking-tight border border-slate-200/50">
                              {r}
                            </span>
                          ))}
                          {v.reminders.length === 0 && <span className="text-[10px] text-slate-300 font-bold uppercase tracking-widest italic">None sent</span>}
                        </div>
                      </td>
                      <td className="py-6 px-6 text-right">
                        <button 
                          onClick={() => handleSendFeedbackReminder(v.id)}
                          className="px-5 py-2.5 bg-tata-blue/5 text-tata-blue rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-tata-blue hover:text-white transition-all cursor-pointer border border-tata-blue/10"
                        >
                          Send Nudge
                        </button>
                      </td>
            ...
            <div className="p-10 bg-emerald-50 rounded-[3rem] border border-emerald-100 flex flex-col md:flex-row items-center justify-between gap-10 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-12 opacity-5">
    ...
    <div className="space-y-12">
      ...
      {!isOrientationDismissed && (
        <motion.div 
          ...
          className="p-8 bg-gradient-to-br from-tata-blue via-blue-900 to-slate-900 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group"
        >
      ...
      <section>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-tata-cyan animate-pulse" />
              <span className="text-[10px] font-black text-tata-blue uppercase tracking-[0.3em]">
                {spoc.tier} Dashboard
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {[
          ...
          <motion.div 
            ...
            className={`p-8 rounded-[2.5rem] bg-white border ${stat.border} shadow-sm hover:shadow-xl transition-all group relative overflow-hidden`}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-10">
          <div className="bg-white rounded-[3rem] p-10 shadow-sm border border-slate-100">
            <div className="flex justify-between items-center mb-10">
              ...
              <button className="px-5 py-2 bg-slate-50 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-100 transition-all cursor-pointer">View All Activity</button>
            </div>
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-6 rounded-[2rem] hover:bg-slate-50 transition-all group border border-transparent hover:border-slate-100">
                  ...
                  <div className="text-right">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">{item.time}</span>
        ...
        <div className="space-y-10">
          <div className="bg-zinc-900 rounded-[3rem] p-10 text-white shadow-2xl shadow-zinc-900/20 relative overflow-hidden">
            ...
            <h3 className="text-xs font-black text-white/30 uppercase tracking-[0.3em] mb-8 relative z-10">Quick Actions</h3>
            ...
            <div className="mt-10 pt-8 border-t border-white/5">
              <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl">
                <div className="w-10 h-10 rounded-xl bg-tata-blue flex items-center justify-center">
                  <Info size={20} className="text-white" />
                </div>
                <div>
                  <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Need Help?</p>
    ...
    return (
      <div className="space-y-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <button onClick={() => setShowAddSpoc(true)} className="group px-8 py-4 bg-zinc-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest flex items-center gap-3 hover:bg-tata-blue transition-all shadow-xl shadow-zinc-900/10 cursor-pointer active:scale-95">
            <Plus size={18} className="group-hover:rotate-90 transition-transform" /> Add New SPOC
          </button>
        </div>

        {/* Filters */}
        <div className="flex flex-wrap items-center gap-6 p-6 bg-white rounded-[2rem] border border-slate-100 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <select 
              className="bg-slate-50 border-none text-sm font-black text-slate-700 px-6 py-4 rounded-2xl focus:ring-2 focus:ring-tata-blue/20 outline-none cursor-pointer uppercase tracking-widest"
                    ...
                    <tr key={s.id} className={`group transition-all ${!isOwnCompany ? "opacity-40 grayscale hover:grayscale-0 hover:opacity-100" : "hover:bg-slate-50/50"}`}>
                      <td className="py-6 px-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <div className="font-black text-slate-900 tracking-tight text-base">{s.name}</div>
                            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">{s.email}</div>
                          </div>
                        </div>
                      </td>
                      <td className="py-6 px-6">
                      ...
                      <td className="py-6 px-6 text-sm font-black text-slate-700 tracking-tight">{s.company}</td>
                      ...
                      <td className="py-6 px-6">
                        <div className="flex items-center gap-2.5">
                          ...
                          <span className="text-xs font-black text-slate-900 uppercase tracking-tight">{s.status}</span>
                        </div>
                      </td>
                      <td className="py-6 px-6 text-[10px] font-bold text-slate-400 uppercase tracking-widest">{s.lastActive}</td>
                      <td className="py-6 px-6 text-right">
                        {canEdit ? (
                          <div className="flex justify-end gap-3">
                            <button onClick={() => setEditingSpoc(s)} className="w-10 h-10 rounded-xl bg-slate-50 text-slate-400 hover:bg-tata-blue hover:text-white transition-all flex items-center justify-center cursor-pointer shadow-sm">
                              <Edit2 size={18} />
                            </button>
                            <button onClick={() => setDeactivatingSpoc(s)} className="w-10 h-10 rounded-xl bg-slate-50 text-slate-400 hover:bg-red-500 hover:text-white transition-all flex items-center justify-center cursor-pointer shadow-sm">
                              <Pause size={18} />
                            </button>
                          </div>
                        ) : (
                          <div className="relative group/tooltip inline-block">
                            <div className="w-10 h-10 rounded-xl bg-slate-50 text-slate-200 flex items-center justify-center cursor-help">
                              <Lock size={18} />
                            </div>
                            <div className="absolute bottom-full right-0 mb-3 hidden group-hover/tooltip:block w-56 p-4 bg-zinc-900 text-white text-[10px] font-bold rounded-2xl shadow-2xl z-20 leading-relaxed uppercase tracking-widest">
          ...
          <div className="flex gap-2 p-1.5 bg-slate-100 rounded-2xl shadow-inner">
            {["Pending", "Approved", "Rejected"].map((tab) => (
              <button 
                ...
                className={`px-8 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all cursor-pointer flex items-center gap-3 ${
              ...
              >
                ...
                {tab === "Pending" && approvals.filter(a => a.status === "Pending").length > 0 && (
                  <span className="bg-red-500 text-white text-[10px] w-5 h-5 flex items-center justify-center rounded-full font-black shadow-sm">
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredApprovals.map((a) => (
                  <tr key={a.id} className="group hover:bg-slate-50/50 transition-all">
                    <td className="py-6 px-6">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center font-black text-lg text-slate-400 group-hover:bg-tata-blue group-hover:text-white transition-all shadow-sm">
                          {a.name.charAt(0)}
                        </div>
                        <div>
                          <div className="font-black text-slate-900 tracking-tight text-base">{a.name}</div>
                          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">{a.email}</div>
                        </div>
                      </div>
                    </td>
                    <td className="py-6 px-6">
                    ...
                    <td className="py-6 px-6">
                      <button 
                        ...
                        className="group/btn px-4 py-2 bg-slate-50 text-tata-blue rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-tata-blue hover:text-white transition-all flex items-center gap-2 cursor-pointer border border-tata-blue/10 shadow-sm"
                      >
                    ...
                    {approvalTab === "Rejected" && (
                      <td className="py-6 px-6">
                        <div className="p-3 bg-red-50 rounded-xl border border-red-100">
                          <p className="text-[10px] text-red-600 font-bold uppercase tracking-tight italic leading-relaxed">{a.rejectionReason}</p>
                        </div>
                      </td>
                    )}
                    <td className="py-6 px-6 text-right">
    ...
    return (
      <div className="space-y-12">
        ...
        <div className="flex flex-wrap items-center gap-6 p-6 bg-white rounded-[2rem] border border-slate-100 shadow-sm">
          ...
          <select 
            className="bg-slate-50 border-none text-sm font-bold text-slate-700 px-4 py-2 rounded-xl focus:ring-2 focus:ring-tata-blue/20 outline-none cursor-pointer"
          ...
          <div className="flex items-center gap-3 px-4 py-2 bg-slate-50 rounded-xl text-xs font-bold text-slate-500 border border-transparent hover:border-slate-200 transition-all cursor-default">
            <Calendar size={14} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
          {filteredEvents.map((event) => (
            <motion.div 
              key={event.id}
              layout
              className="bg-white rounded-[3rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100 flex flex-col group"
            >
              <div className="p-10 space-y-8 flex-1">
                <div className="flex justify-between items-start">
                  ...
                  {event.vibeStatus && (
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-amber-50 text-amber-600 rounded-xl border border-amber-100">
                      <Sparkles size={12} />
                      <span className="text-[10px] font-bold uppercase tracking-tight">{event.vibeStatus}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="pt-8 border-t border-slate-50">
                  <div className="flex justify-between items-center mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Registration Capacity</span>
                    </div>
                    <span className="text-xs font-black text-slate-900">{event.capacity}</span>
                  </div>
                ...
                {event.status === "Completed" && !event.vibeStatus && (
                  <button 
                    ...
                    className="w-full py-4 bg-tata-cyan text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-tata-blue transition-all shadow-lg shadow-tata-cyan/20 cursor-pointer active:scale-95"
                  >
                    Submit to TVW Vibe
                  </button>
                )}
              ...
              <div className="bg-slate-50/50 border-t border-slate-100">
                <button 
                  ...
                  className="w-full p-6 flex items-center justify-between text-xs font-black text-slate-500 hover:bg-slate-100 transition-all cursor-pointer group/btn"
                >
                  <div className="flex items-center gap-3">
                            ...
                            <div key={v.id} className="flex items-center justify-between bg-white p-4 rounded-[1.5rem] border border-slate-100 shadow-sm hover:border-tata-blue/20 transition-all">
                              ...
                              <div className="flex items-center gap-4">
                                <div className="relative">
                                  <input 
                                    type="number" 
                                    className="w-20 pl-3 pr-8 py-2 text-xs font-bold border border-slate-200 rounded-xl focus:ring-2 focus:ring-tata-blue/10 outline-none"
                                ...
                                {v.confirmed ? (
                                  ...
                                  <button 
                                    ...
                                    className="px-4 py-2 bg-tata-blue text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-900 transition-all cursor-pointer"
                                  >
                                    Confirm
                                  </button>
                                )}
      ...
      <aside className="w-80 bg-white border-r border-slate-100 hidden lg:flex flex-col p-8 fixed h-[calc(100vh-80px)] z-20">
        <div className="mb-10 px-2">
          <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-[1.5rem] border border-slate-100">
            <div className="w-12 h-12 rounded-xl bg-tata-blue flex items-center justify-center text-white font-black text-lg shadow-lg shadow-blue-900/20">
              {spoc.firstName.charAt(0)}
            </div>
            <div>
              <p className="text-sm font-black text-slate-900 tracking-tight">{spoc.firstName} {spoc.lastName}</p>
              <p className="text-[10px] font-bold text-tata-blue uppercase tracking-widest">Corporate SPOC</p>
            </div>
          </div>
        </div>

        <div className="space-y-2 flex-1">
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4 px-4">Main Menu</p>
          {navItems.map((item) => (
            <button 
              key={item.name}
        ...
        <div className="pt-8 mt-8 border-t border-slate-100">
          <div className="p-6 bg-gradient-to-br from-slate-900 to-zinc-800 rounded-[2rem] text-white relative overflow-hidden group">
            ...
            <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.3em] mb-3 relative z-10">Support Hub</p>
            <p className="text-xs font-medium text-white/70 mb-4 relative z-10 leading-relaxed">Need assistance with the SPOC portal?</p>
            <button className="w-full py-3 bg-white/10 hover:bg-white/20 rounded-xl text-xs font-bold transition-all cursor-pointer relative z-10 border border-white/10">
              Contact TSG Admin
            </button>
          </div>
        </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-3">
                      <span className="text-[10px] font-bold bg-blue-50 text-blue-600 px-2 py-1 rounded-lg uppercase tracking-widest">TCS Employee</span>
                      <span className="text-[10px] font-bold bg-slate-100 text-slate-500 px-2 py-1 rounded-lg uppercase tracking-widest">Match: {selectedProEngageVolunteer.match}%</span>
                    </div>
                  </div>
                </div>
        ...
        {showCreateEvent && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-2xl bg-white rounded-[2.5rem] shadow-2xl p-10 max-h-[90vh] overflow-y-auto"
            >
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <button onClick={() => setDeactivatingSpoc(null)} className="flex-1 bg-red-600 text-white py-3 rounded-xl font-bold hover:bg-red-700 transition-all cursor-pointer">Deactivate</button>
              </div>
            </motion.div>
          </div>
        )}
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-red-600 text-white py-3 rounded-xl font-bold hover:bg-red-700 transition-all disabled:opacity-50 cursor-pointer"
                  >
                    Confirm Reject
                  </button>
                </div>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-8">
                <div className="space-y-4">
                  <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Volunteer Profile</p>
                  ...
                  <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Submitted Documents</p>
                    <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[10px] text-slate-400">Uploaded on {selectedApproval.registeredDate}</p>
                      </div>
                      <button className="p-2 hover:bg-slate-50 rounded-lg text-tata-blue cursor-pointer">
                        <Download size={16} />
                      </button>
                    </div>
                    <div className="mt-6 aspect-[3/4] bg-slate-200 rounded-xl flex items-center justify-center text-slate-400 italic text-xs">
              ...
              <div className="p-8 border-t border-slate-100 bg-slate-50 flex gap-4">
                {selectedApproval.status === "Pending" ? (
                  ...
                  <div className={`w-full py-4 rounded-xl text-center font-bold uppercase tracking-widest ${
          ...
          <div className="fixed inset-0 z-[500] flex items-center justify-center p-4 md:p-10">
            ...
            >
              <div className="flex-1 p-12 bg-white flex flex-col items-center text-center border-r border-slate-100">
                ...
                <p className="text-slate-500 uppercase tracking-[0.3em] text-[10px] font-bold mb-12">This is presented to</p>
                ...
                <div className="grid grid-cols-2 gap-20 w-full max-w-sm">
                  <div className="text-center">
                    ...
                    <p className="text-[10px] font-bold text-slate-400 uppercase">Program Head</p>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] font-bold bg-green-100 text-green-700 px-2 py-1 rounded-lg uppercase">Verified</span>
                    </div>
                  </div>
                </div>
                <div className="space-y-3">
...
export default SPOCDashboardView;
 ? "Nudge sent today" : "No recent action"}
                    </div>
                    <button 
                      onClick={() => handleSendNudge(v.id)}
                      disabled={v?import React, { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Menu, X, ChevronRight, User, Users, Briefcase, ShieldCheck, Lock, Eye, CheckCircle2, Search, ExternalLink, Calendar, MapPin, Clock, Award, Info, Filter, CalendarDays, LayoutGrid, Send, FileText, Check, ChevronDown, Sparkles, MessageSquare, ArrowRight, Plus, Edit2, Save, Copy, Pause, History, AlertTriangle, Activity, Download, Upload, Trophy, Share2 } from "lucide-react";
import type { View, Role } from "@/types";
import { ROHAN_DESAI, SPOC_DIRECTORY, PENDING_APPROVALS_DATA, TCS_TVW_EVENTS, PROENGAGE_PIPELINE, AT_RISK_VOLUNTEERS, OPEN_PROENGAGE_PROJECTS, COMPANY_LEADERBOARD, VOLUNTEER_CERTIFICATES, FEEDBACK_MONITOR_DATA } from "@/data/mockData";
...
export default SPOCDashboardView;
 ? "bg-slate-100 text-slate-400" : "bg-zinc-900 text-white hover:bg-tata-blue shadow-lg hover:shadow-tata-blue/20"
                      }`}
                    >
                      {v?import React, { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
