  ...
  return (
    <div className="pt-28 pb-20 px-6 md:px-12 bg-slate-50 min-h-screen flex items-center justify-center">
      <motion.div 
        ...
        className="max-w-2xl w-full glass rounded-[4rem] p-12 md:p-16 shadow-2xl border border-white/20 text-center"
      >
        ...
        <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 mb-10">
          <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Reference ID</div>
        ...
        <div className="space-y-4">
          <button 
            ...
            className="w-full py-5 bg-zinc-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-tata-blue transition-all shadow-xl shadow-black/10 cursor-pointer"
          >
            Return to Dashboard
          </button>
