    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      {step === "initiate" && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="glass rounded-[2.5rem] p-8 shadow-xl border border-white/20">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Select Target Audience</label>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {DR_TEMPLATES.map(template => (
                      ...
                      >
                        <div className="text-[10px] font-black text-tata-blue uppercase tracking-widest mb-1">{template.name}</div>
                        <div className="text-[9px] text-slate-500 line-clamp-2">{template.subject}</div>
                      </button>
                    ))}
                  </div>
                  ...
                  <div className="space-y-4 pt-4">
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Subject Line</label>
                      <input 
                        type="text" 
                        value={customSubject}
                        onChange={(e) => setCustomSubject(e.target.value)}
                        className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-tata-blue/20"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        className="w-full h-40 px-4 py-4 bg-white border border-slate-200 rounded-xl text-sm leading-relaxed focus:outline-none focus:ring-2 focus:ring-tata-blue/20 resize-none"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            <div className="glass rounded-[2.5rem] p-8 shadow-xl border border-white/20">
              <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-6">Alert Summary</h4>
              <div className="space-y-6">
                <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Target Audience</div>
                  ...
                  {audience !== "all" && (
                    <div className="flex flex-wrap gap-1 mt-2">
                      <span className="px-2 py-0.5 bg-tata-blue/10 text-tata-blue text-[9px] font-black uppercase rounded tracking-wider">
                        DR Interest Filter
                      </span>
                    </div>
                  )}
                ...
                <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Estimated Reach</div>
                  ...
                  <div className="text-[9px] text-slate-500 mt-1 uppercase tracking-widest font-bold">Volunteers Notified</div>
                </div>

                <div className="space-y-3 pt-4">
                  <button 
                    onClick={() => setIsPreviewOpen(true)}
                    className="w-full py-4 rounded-2xl border border-slate-200 font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-all flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <button 
                    ...
                    className="w-full py-5 bg-red-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-red-700 transition-all shadow-xl shadow-red-600/20 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isTriggering ? (
            ...
            <div className="p-6 bg-amber-50 rounded-3xl border border-amber-100 flex gap-4">
              ...
              <p className="text-[11px] text-amber-700 leading-relaxed font-medium">
                <span className="font-black uppercase block mb-1">Critical Action</span>
      ...
      {step === "status" && (
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-3xl mx-auto">
          <div className="glass rounded-[3rem] p-12 shadow-2xl border border-white/20 text-center">
            ...
            <div className="grid grid-cols-2 gap-8 mb-12">
              <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Total Notified</div>
                <div className="text-4xl font-black text-tata-blue">{notifiedCount.toLocaleString()}</div>
              </div>
              <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Delivery Status</div>
                <div className="text-xl font-black text-green-600 uppercase tracking-widest">In Progress</div>
              </div>
            </div>
      ...
      {step === "dashboard" && (
        <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-700">
          <div className="flex justify-between items-center">
            ...
            <button onClick={() => setStep("initiate")} className="btn-outline py-3 px-6 text-[10px] font-black uppercase tracking-widest cursor-pointer flex items-center gap-2">
          ...
          {/* Response List */}
          <div className="glass rounded-[2.5rem] overflow-hidden border border-white/20 shadow-xl">
            <div className="p-8 border-b border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest">Volunteer Response List</h4>
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">Select volunteers to form the deployment cadre</p>
              </div>
              <div className="flex items-center gap-3">
                {selectedVolunteers.length > 0 && (
                  <button 
                    ...
                    className="px-6 py-3 bg-tata-blue text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-tata-blue/20 hover:bg-blue-900 transition-all flex items-center gap-2 cursor-pointer"
                  >
                ...
                <button 
                  ...
                  className="px-6 py-3 bg-red-50 text-red-600 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-red-100 transition-all cursor-pointer"
                >
                  Close Response
                </button>
              </div>
            ...
            <div className="p-6 bg-slate-50/50 border-b border-slate-100 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-1">
                <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Geography</label>
                <select 
                  value={filters.geography}
                  onChange={e => setFilters({...filters, geography: e.target.value})}
                  className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-[11px] font-bold focus:outline-none"
                >
              ...
              <div className="space-y-1">
                <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Skill</label>
                <select 
                  value={filters.skill}
              ...
              <div className="space-y-1">
                <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Travel Willingness</label>
                <select 
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50/50">
                    <th className="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest w-10">
                      <input 
                        type="checkbox" 
                    ...
                    <th className="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Volunteer</th>
                    ...
                    <th className="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Skills</th>
                  ...
                  {filteredResponses.length === 0 ? (
                    ...
                    filteredResponses.map((res) => (
                      <tr key={res.id} className={`hover:bg-slate-50/50 transition-colors ${selectedVolunteers.includes(res.id) ? "bg-tata-blue/5" : ""}`}>
                        ...
                        <td className="px-8 py-6">
                          <div className="flex flex-wrap gap-1">
                            {res.skills.map((skill: string) => (
                              <span key={skill} className="px-2 py-0.5 bg-slate-100 text-slate-600 text-[9px] font-bold rounded uppercase tracking-wider">
                                {skill}
                              </span>
                            ))}
                          </div>
                        ...
                        <td className="px-8 py-6">
                          <span className="px-3 py-1 bg-green-50 text-green-600 text-[9px] font-black uppercase rounded-full tracking-widest">Verified</span>
                        </td>
                      </tr>
                    ))
                  )}
          ...
          <div className="glass rounded-[2.5rem] p-8 border border-white/20 shadow-xl">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest">Deployment Log</h4>
            </div>
              ...
              {drDeploymentLog.length === 0 ? (
                ...
                drDeploymentLog.map((log) => (
                  <div key={log.id} className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <div className="text-[10px] font-black text-tata-blue uppercase tracking-widest mb-1">Deployment #{log.id}</div>
                        <div className="text-xs text-slate-500 font-bold">{new Date(log.timestamp).toLocaleString()}</div>
                      </div>
                      <span className="px-3 py-1 bg-green-50 text-green-600 text-[9px] font-black uppercase rounded-full tracking-widest">Instructions Sent</span>
                    </div>
                    <div className="mb-4">
                      <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Selected Cadre ({log.volunteers.length})</div>
                      <div className="flex flex-wrap gap-2">
                        {log.volunteers.map((v: any) => (
                          <span key={v.id} className="px-3 py-1 bg-white border border-slate-200 text-slate-600 text-[10px] font-bold rounded-full">
                            {v.name}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="p-4 bg-white rounded-2xl border border-slate-100">
                      <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Instructions Sent</div>
          ...
          <div className="glass rounded-[2.5rem] p-12 border border-white/20 shadow-xl flex flex-col items-center justify-center text-center min-h-[400px]">
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            >
              <div className="p-8 border-b border-slate-100 flex justify-between items-center">
                <h4 className="font-black text-slate-900 uppercase tracking-widest text-sm">Alert Preview</h4>
                <button onClick={() => setIsPreviewOpen(false)} className="p-2 hover:bg-slate-50 rounded-xl transition-colors"><X size={20} /></button>
              </div>
              <div className="p-8 space-y-6">
                <div className="space-y-4">
                  <div className="p-4 bg-slate-900 text-white rounded-2xl shadow-lg">
                    <div className="text-[10px] font-black text-tata-cyan uppercase tracking-widest mb-1">Push Notification</div>
                    <div className="font-bold text-sm">{customSubject}</div>
                  </div>
                  <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Email Content</div>
                    <div className="font-black text-lg text-slate-900 mb-4">{customSubject}</div>
                    ...
                    <div className="mt-8 pt-8 border-t border-slate-200 flex justify-center">
                      <button className="px-8 py-3 bg-red-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-red-600/20">
                        Respond Now
                      </button>
                    </div>
                  </div>
              ...
              <div className="p-8 bg-slate-50 border-t border-slate-100 flex gap-4">
                <button onClick={() => setIsPreviewOpen(false)} className="flex-1 py-4 bg-white border border-slate-200 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-all cursor-pointer">Close Preview</button>
                <button onClick={() => { setIsPreviewOpen(false); handleTrigger(); }} className="flex-1 py-4 bg-red-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-red-700 transition-all shadow-xl shadow-red-600/20 cursor-pointer">Confirm & Send</button>
              </div>
            </motion.div>
          </div>
        )}
