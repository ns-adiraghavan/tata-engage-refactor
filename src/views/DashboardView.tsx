      ...
      <div className="lg:ml-56 max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div id="vol-section-activity" className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm">
            ...
            <h2 className="text-xl font-black text-slate-900 tracking-tight mb-6">Your Activity</h2>

            {IS_PE_SEASON ? (
              <div className="space-y-4">
                {user.activeApplication?.status === "Matched" && (
                  <div className="w-full p-6 bg-slate-50 border border-slate-100 rounded-2xl">
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="text-sm font-bold text-slate-900">{user.activeApplication.title}</h4>
                        <p className="text-xs text-slate-600 mt-1">{user.activeApplication.ngo}</p>
                      </div>
                      <span className="px-3 py-1 rounded-full text-xs font-bold bg-tata-blue/10 text-tata-blue border border-tata-blue/20">Matched</span>
                    </div>
                    <button
                      onClick={() => navigate("active-project-management")}
                      className="mt-4 text-sm font-bold text-slate-700 hover:text-tata-blue cursor-pointer flex items-center gap-1"
                    >
                ...
                <div className="w-full p-6 bg-slate-50 border border-slate-100 rounded-2xl">
                  <h4 className="text-sm font-bold text-slate-900 mb-1">ProEngage is open</h4>
                  <p className="text-xs text-slate-500 mb-4">Find projects matched to your skills</p>
                  <button
              ...
              <div className="space-y-3">
                <div className="p-5 bg-slate-50 border border-slate-100 rounded-2xl">
                  <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Volunteering</p>
                  <p className="text-sm text-slate-700">Explore past TVW events and stay ready for the next edition.</p>
                </div>
              </div>
            )}
          </div>
